...
class Ui_MainWindow(QtGui.QMainWindow):
	def setupUi(self, MainWindow):
		...
		self.btn_comparacion_seleccion.setText(_translate("MainWindow", "Comp. Seleccion", None))
		...
		self.btn_monitoreo_seleccion.setText(_translate("MainWindow", "Mon. Seleccion", None))
		...
		self.btn_monitoreo_detener.setText(_translate("MainWindow", "Det. Monitoreo", None))
		...
		self.btn_añadir_paginas.setText(_translate("MainWindow", "+ Añadir Paginas", None))
		...
		self.btn_eliminar_paginas.setText(_translate("MainWindow", '- Eliminar Paginas', None))
		...
		#Barra de Menu ----------------------------------------------
		"""
		accionSetTimeout = QtGui.QAction("&Cambiar Timeout", self)
		accionSetTimeout.setShortcut("Ctrl+T")
		accionSetTimeout.setStatusTip('Cambiar el tiempo de espera de una conexion')
		accionSetTimeout.triggered.connect(self.prueba)
		"""
		...
		self.actionCambiar_Timeout = QtGui.QAction(MainWindow)
		self.actionCambiar_Timeout.setObjectName(_fromUtf8("actionCambiar_Timeout"))
		self.menuOpciones.addAction(self.actionCambiar_Timeout)
		self.menubar.addAction(self.menuOpciones.menuAction())

		#self.centrallayout.setMenuBar(self.mainMenu)
