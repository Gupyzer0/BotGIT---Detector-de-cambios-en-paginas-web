...
class Ui_Dialogo_Editar_Entes(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Editar lista de entes", None))
        ...
        self.label.setText(_translate("Dialog", "Lista de Entes", None))
