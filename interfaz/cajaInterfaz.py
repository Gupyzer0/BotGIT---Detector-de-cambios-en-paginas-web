...
class Widget_Caja(QtGui.QWidget):
	def __init__(self, parent):
		...
		self.btn_modificar.setMaximumWidth(30)
		...
		self.btn_eliminar.setMaximumWidth(30)
		...
		self.btn_actualizar_porcentaje_portal.setMaximumWidth(40)
		self.btn_actualizar_porcentaje_portal.setText(_translate("MainWindow", "ACT", None))
